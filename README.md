...
1. **GATHERING DATA:**
   ...
   - Once we understand a final outcome we want, we also need to ensure we gave access to and can gather the relevant data that would allow us to do this as well.
