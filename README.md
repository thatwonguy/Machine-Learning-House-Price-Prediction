...
2. **DATA PREPARATION:**
   ...
   - Documentation is important but it can be especially important for this "pre-processing" step, as any future data coming in will also need to be preprocessed/transformed/cleaned in the same manner consistently in order to continue providing results as it passes through the data pipeline and machine learning algorithm/model/etc.
3. **DATA WRANGLING:**
